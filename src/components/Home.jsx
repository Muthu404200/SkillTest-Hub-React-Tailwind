...
function Home() {
  const quizzes = [
    ...
    {
      title: "Tally Quiz",
      description: "Test your knowledge on Accounting & GST in Tally",
      image: "https://img.icons8.com/color/96/commercial.png",
      link: "/quiz/tally",
      comingSoon: false, // ✅ enabled now
    },
    {
      title: "SAP Quiz",
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 relative overflow-hidden bg-gradient-to-br from-[#ffffff] to-[#f5f9ff]">
      ...
      >
        ...
        <span className="font-semibold text-gray-900">Microsoft Tally Quizzes are ready
         & SAP are{" "}
         </span>.
